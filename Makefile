...
build_and_run_antmaze:
	...
	-v ".:/workspace/GuidedRollBackRL" \
	grbrl-corl python $(RUN_FILE) --project AdaptiveAlpha --horizon_fn time_step --checkpoints_path checkpoints --normalize True --tolerance 0.95 --normalize_reward True --iql_deterministic False --beta 10 --learner_frac 0.2 --correct_learner_action 0.9 --iql_tau 0.9 --eval_freq 1000 --n_episodes 100 --offline_iterations 0 --online_iterations 1000000 --pretrained_policy_path GuidedRollBackRL/algorithms/finetune/checkpoints/IQL-antmaze-umaze-diverse-v2-offline/checkpoint_999999.pt --env antmaze-umaze-diverse-v2 --device cpu --adaptive_alpha True --enable_rollback False ;
